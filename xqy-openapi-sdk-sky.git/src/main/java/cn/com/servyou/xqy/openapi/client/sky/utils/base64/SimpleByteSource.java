package cn.com.servyou.xqy.openapi.client.sky.utils.base64;
 ...
 * {@link Hex Hex} and {@link Base64Helper Base64} codec classes to support the
...
public class SimpleByteSource implements ByteSource {
    ...
    public String toBase64() {
        if ( this.cachedBase64 == null ) {
            this.cachedBase64 = Base64Helper.encodeToString(getBytes());
        }
