...
import cn.com.servyou.xqy.openapi.client.sky.auth.ApiKeyAuth;
import cn.com.servyou.xqy.openapi.client.sky.auth.Authentication;
import cn.com.servyou.xqy.openapi.client.sky.auth.HttpBasicAuth;
import cn.com.servyou.xqy.openapi.client.sky.auth.OAuth;
...
public class ApiClient {
    ...
    static {
        ...
        if (IS_ANDROID) {
            try {
                sdkVersion = Class.forName("android.os.Build$VERSION").getField("SDK_INT")
                    .getInt(null);
            } catch (Exception e) {
                try {
                    sdkVersion = Integer.parseInt((String) Class.forName("android.os.Build$VERSION")
    ...
    private String                      basePath                = "https://open.17dz.com/gateway/sky";
    ...
    public ApiClient() {
        ...
        setUserAgent("xqy-openapi-sdk-sky/1.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:5555/gateway-service
    ...
    /**
     * Getter for property 'appKeySecret'.
     *
     * @return appKeySecret Value for property 'appKeySecret'.
     */
    ...
    /**
     * Setter for property 'appKeySecret'.
     *
     * @param appKeySecret Value to set for property 'appKeySecret'.
     */
     ...
     *
     * @return appKey Value for property 'appKey'.
     */
